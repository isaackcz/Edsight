...
class Topic(models.Model):
    ...
    name = models.CharField(max_length=100)
    display_order = models.IntegerField()
    can_skip = models.BooleanField(default=False, help_text="Whether this topic can be skipped")

    class Meta:
        db_table = 'topics'
        indexes = [
            models.Index(fields=['category'], name='topic_category_id_idx'),
