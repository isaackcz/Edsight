...
from apps.core.models import LoginAttempt, AuditLog
    ...
    def log_answer_change(user, answer, action, old_value=None, ip_address=None, user_agent=None):
        ...
        SystemLogger.log_user_activity(
            ...
            metadata={
                ...
                # sub_question_id removed in new schema
                'old_value': old_value,
...
from apps.core.models import Question, Answer, Form, AdminUser, UsersSchool, School
