...
def form_management_page(request):
    ...
    return render(request, 'form-management/form_management.html', context)
...
def api_regions(request):
    ...
    try:
        ...
        with connection.cursor() as cursor:
            # Get regions that have schools with forms
            cursor.execute("""
                SELECT r.id, r.name, COUNT(DISTINCT s.id) as school_count
                FROM regions r
...
def api_divisions(request):
    ...
    try:
        ...
        with connection.cursor() as cursor:
            ...
            cursor.execute("""
                SELECT d.id, d.name, COUNT(DISTINCT s.id) as school_count
                FROM divisions d
...
def api_districts(request):
    ...
    try:
        ...
        with connection.cursor() as cursor:
            ...
            cursor.execute("""
                SELECT dt.id, dt.name, COUNT(DISTINCT s.id) as school_count
                FROM districts dt
...
def api_schools_table(request):
    ...
    try:
        ...
        base_query = """
            SELECT DISTINCT s.id, s.school_name, s.school_id, 
                   r.name as region_name, d.name as division_name, dt.name as district_name,
