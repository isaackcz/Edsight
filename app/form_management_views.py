...
from .models import (
    ...
    Region, Division, District, School, Category, SubSection, Topic, Question
)
from .admin_utils import require_admin_permission, log_admin_activity
...
def api_form_detail(request, form_id):
    ...
    try:
        ...
        form = Form.objects.select_related(
            ...
            'answers__question__topic__sub_section__category',
            'answers__sub_question'
        ).get(form_id=form_id)
